                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form action="/barang/nonTanaman/update" method="POST" autocomplete="off"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input hidden type="text" value="{{ $res->id_barang }}" />
                                                ...
                                                <div class="card-header ">
                                                    ...
                                                    <div class="col-lg-6 col-sm-12">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-sm-12">
                                                                    ...
                                                                    <input type="text" name="nama_barang" value="{{ $res->nama_barang }}" id="nama_tanaman"
                                                                ...
                                                                <div class="col-lg-6 col-sm-6">
                                                                    ...
                                                                    <select class="select2 form-control form-control-sm"
                                                                        ...
                                                                        <option value="{{ $res->id_indukKategori}}" selected>{{ $res->nama_indukKategori }}</option>
                                                                ...
                                                                <div class="col-lg-6 col-sm-6">
                                                                    ...
                                                                    <input value="{{ $res->berat }}" type="text" name="berat"
                                                                        class="form-control form-control-sm">
                                                                ...
                                                                <div class="col-lg-6 col-sm-6">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input value="{{ $res->diskon }}" id="diskon" name="diskon" value="0"
                                                                            type="number"
                                                                            class="form-control form-control-sm"
                                                                            required>
                                                                        <div class="input-group-prepend">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="container-fluid">
                                                            <div class="card card-default">
                                                                <div class="card-header ">
                                                                    <label>Foto Detail Produk</label>
                                                                    <div class="row">
