        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Laporan Stok Terjual</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-header">
                        <h3 class="card-title"><a href="{{ url('/laporan/stok/terjual/export') }}" type="button" class="btn btn-sm btn-primary"><i class="fa fa-file" aria-hidden="true"></i>
