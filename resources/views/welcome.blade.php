...
<head>
    ...
    <!--slinky menu css-->
    <link rel="stylesheet" href="{{ asset('user/assets/css/slinky.menu.css') }}">
    <!--plugins css-->
                            ...
                            <ul>
                                <li class="currency"><a href="#"> USD <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown_currency">
                                        <li><a href="#">EUR</a></li>
                                        <li><a href="#">GPB</a></li>
                                        <li><a href="{{ '/testHalaman'}}">RUP</a></li>
                                    </ul>
                                </li>
                        ...
                        <div id="menu" class="text-left ">
                            <ul class="offcanvas_main_menu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children">
                                            <a href="{{ url('test')}}">Shop Layouts</a>
                                            <ul class="sub-menu">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a class="btn btn-primary" href="{{ url('test') }}" role="button">Link</a>
                               <span>AMAZINasdasldasdhlG  FROM Lukani </span>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content">
                                ...
                                <h1>lukani <br> <span>trending 2019</span></h1>
                                <p>Discount 20% Off For Lukani Members </p> 
                                <a class="button" href="shop.html">Discover Now </a>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content">
                                <span>AMAZING FROM Lukani </span>
                                <h1>houseplant <br> <span>amazing cholce</span></h1>
                                <p>Discount 20% Off For Lukani Members </p>
                                <a class="button" href="shop.html">Discover Now </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="welcome_lukani_content">
                            ...
                            <div class="welcome_lukani_desc">
                                <p>Commodo sociosqu venenatis cras dolor sagittis integer luctus sem primis eget maecenas
...
============================================ -->
<!--jquery min js-->
<script src="{{ asset('user/assets/js/vendor/jquery-3.4.1.min.js') }}"></script>
<!--popper min js-->
...
<!--slinky menu js-->
<script src="{{ asset('user/assets/js/slinky.menu.js') }}"></script>
<!-- Plugins JS -->
...
<!-- Mirrored from demo.hasthemes.com/lukani-preview-v1/lukani/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 11:40:34 GMT -->
</html>