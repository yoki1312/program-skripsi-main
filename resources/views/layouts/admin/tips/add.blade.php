    ...
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">
                <div class="row">
                    <div class="col-12">
                        <h3 class="card-title">Tambah Tips & Artikel</h3>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form action="{{ url('/tips/store') }}" method="POST" autocomplete="off"
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12" style="margin-top:10px;">
                                                                    <label>Tips</label><br>
                                                                    <textarea  class="hastag" id="keterangan" name="isi"
                                                                ...
                                                                <label>Hastag</label><br>
                                                                     <textarea name="hastag" id="hastag" class="form-control" id="exampleFormControlTextarea1" >#plantshop.id</textarea>
                                                                </div>
