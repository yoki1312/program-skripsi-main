        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">JenisTanaman</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <span class="modal-title" id="exampleModalLongTitle">JenisTanaman</span>
            <input name="nama_kaegori" id="namaJenisTanaman" class="form-control form-control-sm" type="text">
...
<div class="modal fade" id="editform" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
            <span class="modal-title" id="exampleModalLongTitle">JenisTanaman</span>
            <input name="nama_JenisTanaman" id="nama_JenisTanaman" class="form-control form-control-sm" type="text">
            <input hidden name="id_JenisTanaman" id="id_JenisTanaman" class="form-control form-control-sm" type="text">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Close</button>
