        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Green Dekor</a></li>
                    <li class="breadcrumb-item active">Green Dekor</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <h3 class="card-title"><a href="{{ url('greendekor/create') }}" type="button" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                                Tambah baru</a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
