    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <span class="modal-title" id="exampleModalLongTitle">Sub Kategori</span>
                <input name="nama_subKategori" id="nama_subKategoriadd" class="form-control form-control-sm"
                    type="text">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                <span class="modal-title" id="exampleModalLongTitle">Sub Kategori</span>
                <input name="nama_subKategori" id="nama_subKategori" class="form-control form-control-sm" type="text">
                <input hidden name="id_subKategori" id="id_subKategori" class="form-control form-control-sm"
                    type="text">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="importExcel" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <form method="post" action="/subKategori/import_excel" enctype="multipart/form-data">
        @csrf
            <div class="modal-content">
                <div class="modal-header">
