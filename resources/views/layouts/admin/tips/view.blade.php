        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Tips dan Trick</a></li>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <div class="card">
                    ...
                    <h3 class="card-title"><a href="{{ url('tipss/create') }}" type="button" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                                Tambah baru</a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
