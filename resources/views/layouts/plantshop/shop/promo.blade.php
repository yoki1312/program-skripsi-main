                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        <div class="product_thumb">
                                            <a class="primary_img" href="{{ url('detail/produk/'.$r->id_barang) }}"><img style="width:300px; height:250px;" src="{{ asset('upload/img_barang/'.$r->gambar_sampul) }}" alt=""></a>
                                            <div class="label_product">
                                                <span class="label_sale">- {{ $r->diskon }}</span>
                                            </div>
